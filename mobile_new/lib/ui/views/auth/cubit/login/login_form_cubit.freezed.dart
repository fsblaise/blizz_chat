...
class _$LoginFormStateImpl
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginFormState(email: $email, password: $password, isValid: $isValid, emailError: $emailError, passwordError: $passwordError)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, email, password, isValid, emailError, passwordError);
